...
/*
ПРИМЕЧАНИЯ
Для упрощения использовал свой фрейворк github.com/adverax/echo.

В качестве базы данных использовал MySQL, поскольку с sqllite под golang не работал. Если это принципиально, могу реализовать.

Для конверсии изображения использовал внешнюю библиотеку github.com/nfnt/resize (не знаю, насколько она хороша).

Приложение не тестировал вообще, поскольку тестирование в задании не было заявлено.

Выполнение заняло 2 часа. Если что не так, пишите.
*/
